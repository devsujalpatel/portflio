      ...
      >
        ...
        <div className="pt-4 border-t border-gray-200 dark:border-gray-700">
          ...
          <button
            ...
            className="mt-4 block w-full px-4 py-2 rounded-lg bg-gradient-to-tr from-violet-600 to-violet-400 font-bold"
          >
            Contact Me
          </button>
        </div>
            ...
            >
              ...
              <form className="space-y-4">
                ...
                <motion.button
                  ...
                  whileTap={{ scale: 0.97 }}
                  className="w-full px-4 py-2 bg-gradient-to-r from-blue-600 to-violet-400 hover:from-violet-700 hover:to-purple-700 transition-all duration-300 rounded-lg shadow-md hover:shadow-lg hover:shadow-violet-600/50"
                >
                  Send Message
                </motion.button>
              </form>
